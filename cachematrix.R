...
# computing it repeatedly. This assignment requires writing a pair of functions that 
# cache the inverse of a matrix. The following two 
...
# inverse.
# The function makeCacheMatrix creates a list containing a function which
...
# retrieve the inverse from the cache. If not, then it will calculate the inverse 
# and set it to the value in the cache.
